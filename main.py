...
chrome.find_element(By.CSS_SELECTOR, '#form-ele-username').send_keys('1artingh')
chrome.execute_script('document.querySelector("#form-ele-password").value = "artin1386"')
